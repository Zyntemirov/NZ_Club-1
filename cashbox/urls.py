...
urlpatterns = [
    ...
    path('transfer/history/<int:user_id>/<str:from_date>/<str:before_date>', TransferHistoryUserView.as_view()),
    path('cash_box/history/<int:user_id>/<str:from_date>/<str:before_date>', CashBoxHistoryUserView.as_view()),
    path('transfer/notification/<int:user_id>', TransferNotificationUserView.as_view()),
